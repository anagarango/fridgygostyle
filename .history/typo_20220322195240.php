...
<body>
    ...
    <div class = "size">
        ...
        <span class = "regular-ubuntu-one">Ubuntu regular</span>
        <span class = "regular-ubuntu-two">Ubuntu regular</span>
        <span class = "bold-ubuntu-two">Ubuntu bold</span>
        <span class = "regular-ubuntu-three">Ubuntu bold</span>
    </div>
